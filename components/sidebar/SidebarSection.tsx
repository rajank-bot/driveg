  ...
  return (
    ...
    >
      <button
        ...
        aria-haspopup="true"
        className="select-none inline-flex items-center bg-white border-0 cursor-pointer transition-shadow duration-75 ease-linear"
        style={{
          borderRadius: '0.8rem',
          boxShadow:
      ...
      <NewMenu isOpen={isMenuOpen} onClose={closeMenu} buttonRef={buttonRef} />
    </div>
  )
}
